...
class AdminController extends AbstractController
{
    ...
    public function index(): Response
    {
        ...
        return $this->render('admin/index.html.twig', [
            'users' => $usersList,
            'role_specialist' => $_ENV["ROLE_SPECIALIST"],
    ...
    #[Route('/admin/enablspecialist_role', name: 'enable_specialist')]
    public function enableAuthor(Request $request): Response
    {
        //$userId = $this->getUser()->getId();
        $userId = $request->query->get('id');
        $this->roleRepo->updateAutherRole($_ENV['ROLE_SPECIALIST'],$userId);

        return $this->redirectToRoute("app_admin");
    }

    #[Route('/admin/remove_specialist_role', name: 'remove_specialist')]
    public function removeAuthor(Request $request): Response
    {
        //$userId = $this->getUser()->getId();
        $userId = $request->query->get('id');
        $this->roleRepo->removeAutherRole($_ENV['ROLE_SPECIALIST'],$userId);
        return $this->redirectToRoute("app_admin");
    }
