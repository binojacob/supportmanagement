...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'user', targetEntity: SupportCase::class)]
    ...
    public function addSupportCase(SupportCase $supportCase): self
    {
        if (!$this->supportCases->contains($supportCase)) {
            $this->supportCases->add($supportCase);
            $supportCase->setUser($this);
        }

        return $this;
    }

    public function removeSupportCase(SupportCase $supportCase): self
    {
        if ($this->supportCases->removeElement($supportCase)) {
            // set the owning side to null (unless already changed)
            if ($supportCase->getUser() === $this) {
                $supportCase->setUser(null);
            }
        }
